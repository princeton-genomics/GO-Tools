...
#			    },
			sgd => {
			    GENE_URL => 'http://www.yeastgenome.org/cgi-bin/locus.pl?locus=',
			    COMMON_NAME => 'Yeast',
			    ORGANISM => 'Saccharomyces cerevisiae',
			    ORGANISM_DB_NAME => 'SGD',
			    ORGANISM_DB_URL => 'http://www.yeastgenome.org/',
			    DEFAULT_GENE_URL => 'http://www.yeastgenome.org/cgi-bin/locus.pl?locus'.'=YPL250C',
